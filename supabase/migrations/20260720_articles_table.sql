-- ─────────────────────────────────────────────────────────────────────────────
-- Table: articles
-- Stores educational articles shown in ConsejosScreen.
-- Edit content directly in Supabase dashboard — app falls back to local data.
-- ─────────────────────────────────────────────────────────────────────────────

CREATE TABLE IF NOT EXISTS public.articles (
  id           TEXT        PRIMARY KEY,
  category     TEXT        NOT NULL,         -- cycle | nutrition | health | fitness | sleep
  icon         TEXT,
  ...
  summary_en   TEXT,
  summary_fr   TEXT,
  body_es      TEXT[]      NOT NULL,         -- array of paragraphs
  body_en      TEXT[],
  body_fr      TEXT[],
...
INSERT INTO public.articles (id, category, icon, read_time, sort_order,
  title_es, title_en, title_fr,
  summary_es, summary_en, summary_fr,
  body_es, body_en, body_fr)
VALUES

('nutrition-menstrual', 'nutrition', '🩸', 4, 1,
  'Qué comer durante la menstruación',
  'What to eat during your period',
  'Que manger pendant les règles',
  'Los alimentos correctos pueden reducir el dolor, los antojos y la fatiga menstrual.',
  'The right foods can reduce pain, cravings and menstrual fatigue.',
  'Les bons aliments peuvent réduire la douleur, les envies et la fatigue menstruelle.',
  ARRAY[
    ...
    'Reduce el consumo de sal y alcohol, que aumentan la retención de líquidos y empeoran la hinchazón. Los ácidos grasos omega-3 del salmón, las nueces y las semillas de lino tienen efecto antiinflamatorio demostrado.',
...
('cycle-training', 'fitness', '🏋️', 5, 2,
  'Entrena con tu ciclo, no contra él',
  'Train with your cycle, not against it',
  'Entraîne-toi avec ton cycle, pas contre lui',
  'Sincronizar tu entrenamiento con tus fases hormonales multiplica los resultados y reduce las lesiones.',
  'Syncing your training with your hormonal phases multiplies results and reduces injury.',
  'Synchroniser ton entraînement avec tes phases hormonales multiplie les résultats et réduit les blessures.',
  ARRAY[
...
('endometriosis-nutrition', 'health', '🌿', 6, 3,
  'Endometriosis y alimentación antiinflamatoria',
  'Endometriosis and anti-inflammatory nutrition',
  'Endométriose et alimentation anti-inflammatoire',
  'La dieta no cura la endometriosis, pero puede reducir significativamente el dolor y la inflamación.',
  'Diet does not cure endometriosis, but it can significantly reduce pain and inflammation.',
  'L''alimentation ne guérit pas l''endométriose, mais elle peut réduire significativement la douleur et l''inflammation.',
  ARRAY[
...
('pcos-hormones', 'health', '🔄', 5, 4,
  'SOP: equilibrio hormonal a través del estilo de vida',
  'PCOS: hormonal balance through lifestyle',
  'SOPK : équilibre hormonal par le style de vie',
  'El síndrome de ovario poliquístico responde muy bien a cambios en la alimentación y el ejercicio.',
  'Polycystic ovary syndrome responds very well to changes in diet and exercise.',
  'Le syndrome des ovaires polykystiques répond très bien aux changements alimentaires et à l''exercice.',
  ARRAY[
...
('sleep-cycle', 'sleep', '🌙', 4, 5,
  'Cómo el sueño regula tus hormonas',
  'How sleep regulates your hormones',
  'Comment le sommeil régule tes hormones',
  'El sueño de calidad no es un lujo: es la base sobre la que se construyen tus ciclos hormonales.',
  'Quality sleep is not a luxury: it is the foundation on which your hormonal cycles are built.',
  'Un sommeil de qualité n''est pas un luxe : c''est la base sur laquelle se construisent tes cycles hormonaux.',
  ARRAY[
...
('pregnancy-nutrition', 'health', '🤰', 5, 6,
  'Nutrición en el embarazo: los esenciales',
  'Nutrition during pregnancy: the essentials',
  'Nutrition pendant la grossesse : les essentiels',
  'Lo que comes durante el embarazo influye en el desarrollo del bebé y en tu recuperación post-parto.',
  'What you eat during pregnancy influences baby development and your postpartum recovery.',
  'Ce que tu manges pendant la grossesse influence le développement du bébé et ta récupération post-partum.',
  ARRAY[
