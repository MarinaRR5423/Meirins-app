...
const st = StyleSheet.create({
  ...
  title:       { fontSize: 20, color: '#0A1823', marginBottom: 8, fontFamily: F.headingX },
  link:        { fontSize: 13, color: '#0A1823', fontFamily: F.bodyB },
  ...
  tagTxt:      { fontSize: 10, fontFamily: F.bodyB, color: '#0A1823', textTransform: 'uppercase', letterSpacing: 0.3 },
  ...
  sessionLabel:{ fontSize: 11, fontFamily: F.bodyB, color: '#0A1823', letterSpacing: 1, marginBottom: 8 },
  ...
  doneBtnTxt:  { color: '#ECF5FD', fontFamily: F.bodyB, fontSize: 14 },
