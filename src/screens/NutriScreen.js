...
const styles = StyleSheet.create({
 ...
 // Semana — calendario Figma
 weekStripCard: { backgroundColor: '#F5F5F5', borderRadius: 32, padding: 16, marginBottom: 2, gap: 8 },
 ...
 weekDayLabel: { fontSize: 10, fontFamily: F.body, color: '#737373', textTransform: 'uppercase' },
 weekStripRow: { flexDirection: 'row', gap: 2 },
 ...
 recipeOrangeCard: { backgroundColor: '#FE6004', borderRadius: 24, padding: 16, gap: 24 },
 recipeOrangeKcal: { fontSize: 18, fontFamily: F.heading, color: '#260E01' },
 recipeOrangeMacroLabel: { fontSize: 14, fontFamily: F.body, color: '#260E01', lineHeight: 19.6 },
