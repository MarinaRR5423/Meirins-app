...
const styles = StyleSheet.create({
  ...
  greetingName: { fontSize: 18, color: '#0A0A0A', fontFamily: F.headingX },
  ...
  heroHeadline: { fontSize: 26, color: '#0A0A0A', lineHeight: 30, fontFamily: F.headingX },
  ...
  mealTitle: { fontSize: 26, color: '#260E01', lineHeight: 30, marginTop: 2, marginBottom: 10, fontFamily: F.headingX },
  ...
  mealTagTxt: { fontSize: 10, fontFamily: F.bodyB, color: '#260E01', textTransform: 'uppercase', letterSpacing: 0.3 },
  ...
  habitBigTxt: { fontSize: 28, color: '#A157C9', marginBottom: 2, fontFamily: F.headingX },
  ...
  tipQuote: { fontSize: 24, color: 'white', lineHeight: 28, marginTop: 16, fontFamily: F.headingX },
